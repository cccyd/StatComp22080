#' @title CNN network used for classification
#' @description CNN network for multi-class graph classification
#' @param num_classes the total kinds of labels
#' @param batch_size the size of samples will be used to update CNN at one time
#' @param epochs number of CNN training times
#' @param datasets the dataset used for training
#' @import keras
#' @import stats
...
#' @title DNN network used for classification
#' @description DNN network for multi-class graph classification
#' @param num_classes the total kinds of labels
#' @param batch_size the size of samples will be used to update CNN at one time
#' @param epochs number of CNN training times
#' @param datasets the dataset used for training
